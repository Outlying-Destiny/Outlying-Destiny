ServerEvents.recipes(event => {
    ...
    function smelterraw(output1, outputchance1, output2, outputchance2, input){event.custom({"type": "thermal:smelter","ingredient": {"tag": input},"result": [{"item": output1,"chance": outputchance1,"locked": true},{"item": output2,"chance": outputchance2}]})}
    ...
    function pulverizerraw(output1, outputchance1, output2, outputchance2, input){event.custom({"type": "thermal:pulverizer","ingredient": {"tag": input},"result": [{"item": output1,"chance": outputchance1,"locked": true},{"item": output2,"chance": outputchance2}]})}
