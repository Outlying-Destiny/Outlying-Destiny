ServerEvents.recipes(event => {
    ...
    alloy3('thermal:enderium_ingot', 1, 'chemlib:platinum_ingot', 1, 'thermal:lead_ingot', 1, 'enderio:pulsating_alloy_ingot', 1, 12000)
    ...
    alloy3('enderio:conductive_alloy_ingot', 1, 'minecraft:redstone', 1, 'enderio:copper_alloy_ingot', 1, 'thermal:invar_ingot', 1, 8000)
    ...
    alloy3('extendedcrafting:black_iron_ingot', 4, 'thermal:tar', 4, 'enderio:dark_steel_ingot', 3, 'immersiveengineering:ingot_hop_graphite', 1, 48000)
    ...
    alloy3('thermal_extra:twinite_ingot', 1, 'industrialforegoing:pink_slime_ingot', 1, 'kubejs:crystalline_alloy_ingot', 1, 'minecraft:netherite_ingot', 1, 18000)
