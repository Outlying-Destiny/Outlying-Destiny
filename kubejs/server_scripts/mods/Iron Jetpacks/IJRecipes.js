ServerEvents.recipes(event => {
    ...
    //Thrusters
    function thruster(output, input1, input2, input3){event.shaped(Item.of('ironjetpacks:thruster', `{Id:"ironjetpacks:${output}"}`), ['ABA','BCB','DED'], {A:input1,B:input2,C:'thermal:dynamo_'+input3,D:'thermal:signalum_block',E:'kubejs:red_alloy_gear'})}
