ServerEvents.recipes(event => {
    ...
    dissolution('industrialforegoing:speed_addon_2', 1, 'thermal_extra:twinite', 500, 'mekanism:hdpe_sheet', 'industrialforegoing:speed_addon_1', 'botania:manasteel_ingot', 'mekanism:hdpe_sheet', 'kubejs_thermal:twinite_machine_speed_augment', 150)
