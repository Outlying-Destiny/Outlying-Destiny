ServerEvents.recipes(event => {
    ...
    function armored(number){event.replaceInput({output:'simplyjetpacks:jetpack_te'+number+'_armored'},'simplyjetpacks:armorplating_te'+number,'kubejs:armorplating_te'+number)} //This is top coding
    ...
    event.replaceInput({output:'simplyjetpacks:jetpack_te3'},'thermal:electrum_ingot','extendedcrafting:black_iron_ingot')
    ...
    event.replaceInput({output:'simplyjetpacks:jetpack_te4'},'thermal:enderium_ingot','thermal_extra:dragonsteel_ingot')
