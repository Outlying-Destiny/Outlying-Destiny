ServerEvents.recipes(event => {
    ...
    mineral3(['minecraft:deepslate_coal_ore', 'minecraft:deepslate_diamond_ore', 'thermal:deepslate_sulfur_ore'], [0.85, 0.1, 0.05], 'minecraft:overworld', 20, 'carbon_rich', 'Carbon-Rich', '§r§fCommon')
