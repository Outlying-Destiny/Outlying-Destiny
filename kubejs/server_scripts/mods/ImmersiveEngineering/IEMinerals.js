ServerEvents.recipes(event => {
    ...
    mineral3(['mekanism:deepslate_osmium_ore', 'thermal:deepslate_nickel_ore', 'minecraft:deepslate_copper_ore'],[0.6, 0.2, 0.2], 'minecraft:overworld', 16, 'osmium', 'Osmium', '§r§bUncommon')
