ServerEvents.recipes(event => {
    ...
    function mineral2(output, outputchance, dim, weight, id, name, rarity){
        event.custom({"type":"immersiveengineering:mineral_mix","dimensions":[dim],"weight":weight,"fail_chance":0,"ores":[{"chance":outputchance[0],"output":{"item":output[0]}},{"chance":outputchance[1],"output":{"item":output[1]}}]}).id('immersiveengineering:mineral/'+id)
        event.custom({"type": "custommachinery:custom_machine","machine": "kubejs:excavator","time": 45,"requirements": [{ "type": "custommachinery:item", "mode": "input", "item": "immersiveengineering:coresample", "nbt": "{display:{Lore:['\""+rarity+"\"'],Name:\'{\"text\":\""+name+"§r\",\"italic\":\"false\"}\'},mineralInfo:[{mineral:\"immersiveengineering:mineral/"+id+"\"}]}", "amount": 1 },{ "type": "custommachinery:item", "mode": "output", "item": output[0], "amount": outputchance[0]*100 },{ "type": "custommachinery:item", "mode": "output", "item": output[1], "amount": outputchance[1]*100 },{ "type": "custommachinery:dimension", "filter": dim }]})
    }

    function mineral3(output, outputchance, dim, weight, id, name, rarity){
        event.custom({"type":"immersiveengineering:mineral_mix","dimensions":[dim],"weight":weight,"fail_chance":0,"ores":[{"chance":outputchance[0],"output":{"item":output[0]}},{"chance":outputchance[1],"output":{"item":output[1]}},{"chance":outputchance[2],"output":{"item":output[2]}}]}).id('immersiveengineering:mineral/'+id)
        event.custom({"type": "custommachinery:custom_machine","machine": "kubejs:excavator","time": 45,"requirements": [{ "type": "custommachinery:item", "mode": "input", "item": "immersiveengineering:coresample", "nbt": "{display:{Lore:['\""+rarity+"\"'],Name:\'{\"text\":\""+name+"§r\",\"italic\":\"false\"}\'},mineralInfo:[{mineral:\"immersiveengineering:mineral/"+id+"\"}]}", "amount": 1 },{ "type": "custommachinery:item", "mode": "output", "item": output[0], "amount": outputchance[0]*100 },{ "type": "custommachinery:item", "mode": "output", "item": output[1], "amount": outputchance[1]*100 },{ "type": "custommachinery:item", "mode": "output", "item": output[2], "amount": outputchance[2]*100 },{ "type": "custommachinery:dimension", "filter": dim }]})
    }

    function mineral4(output, outputchance, dim, weight, id, name, rarity){
        event.custom({"type":"immersiveengineering:mineral_mix","dimensions":[dim],"weight":weight,"fail_chance":0,"ores":[{"chance":outputchance[0],"output":{"item":output[0]}},{"chance":outputchance[1],"output":{"item":output[1]}},{"chance":outputchance[2],"output":{"item":output[2]}},{"chance":outputchance[3],"output":{"item":output[3]}}]}).id('immersiveengineering:mineral/'+id)
        event.custom({"type": "custommachinery:custom_machine","machine": "kubejs:excavator","time": 45,"requirements": [{ "type": "custommachinery:item", "mode": "input", "item": "immersiveengineering:coresample", "nbt": "{display:{Lore:['\""+rarity+"\"'],Name:\'{\"text\":\""+name+"§r\",\"italic\":\"false\"}\'},mineralInfo:[{mineral:\"immersiveengineering:mineral/"+id+"\"}]}", "amount": 1 },{ "type": "custommachinery:item", "mode": "output", "item": output[0], "amount": outputchance[0]*100 },{ "type": "custommachinery:item", "mode": "output", "item": output[1], "amount": outputchance[1]*100 },{ "type": "custommachinery:item", "mode": "output", "item": output[2], "amount": outputchance[2]*100 },{ "type": "custommachinery:item", "mode": "output", "item": output[3], "amount": outputchance[3]*100 },{ "type": "custommachinery:dimension", "filter": dim }]})
    }
    ...
    mineral3(['minecraft:deepslate_coal_ore', 'thermal:deepslate_sulfur_ore', 'minecraft:deepslate_diamond_ore'], [0.8, 0.1, 0.1], 'minecraft:overworld', 20, 'carbon_rich', 'Carbon-Rich', '§r§fCommon')
    mineral3(['evilcraft:dark_ore_deepslate', 'forbidden_arcanus:deepslate_arcane_crystal_ore', 'forbidden_arcanus:runic_deepslate'], [0.60, 0.30, 0.10], 'minecraft:overworld', 10, 'magical', 'Magical', "§r§6Very Rare")
