ServerEvents.recipes(event => {
    ...
    mineral3(['evilcraft:dark_ore_deepslate', 'minecraft:deepslate_lapis_ore', 'minecraft:deepslate_emerald_ore'], [0.65, 0.30, 0.05], 'minecraft:overworld', 10, 'magical', 'Magical', "§r§6Very Rare")
