StartupEvents.registry('block', event => {
  ...
  event.create('dark_soularium_block').displayName('Dark Soularium Block').soundType('metal')
    ...
    .hardness(5.0).resistance(3).requiresTool(true)
    .tagBlock('minecraft:mineable/pickaxe').tagBlock('minecraft:needs_iron_tool')
    event.create('inhibited_zombie_spawner', 'cardinal').displayName('Inhibited Zombie Spawn').soundType('stone')
    .hardness(6.0).resistance(3).requiresTool(true)
    .tagBlock('minecraft:mineable/pickaxe').tagBlock('minecraft:needs_iron_tool')
    event.create('inhibited_witch_spawner', 'cardinal').displayName('Inhibited Witch Spawn').soundType('stone')
    .hardness(6.0).resistance(3).requiresTool(true)
    .tagBlock('minecraft:mineable/pickaxe').tagBlock('minecraft:needs_iron_tool')
    event.create('inhibited_enderman_spawner', 'cardinal').displayName('Inhibited Enderman Spawn').soundType('stone')
    .hardness(6.0).resistance(3).requiresTool(true)
    .tagBlock('minecraft:mineable/pickaxe').tagBlock('minecraft:needs_iron_tool')
    event.create('inhibited_shulker_spawner', 'cardinal').displayName('Inhibited Shulker Spawn').soundType('stone')
    .hardness(6.0).resistance(3).requiresTool(true)
    .tagBlock('minecraft:mineable/pickaxe').tagBlock('minecraft:needs_iron_tool')
