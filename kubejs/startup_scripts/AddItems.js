StartupEvents.registry('item', event => {
    ...
    //Crystals
    event.create('abyssal_crystal').displayName('Abyssal Crystal')
    ...
    event.create('kubejs_actuallyadditions:empowered_enori_crystal_shard').displayName('Empowered Enori Crystal Shard').glow(true)
    event.create('kubejs_actuallyadditions:empowered_palis_crystal_shard').displayName('Empowered Blazis Crystal Shard').glow(true)
    event.create('kubejs_actuallyadditions:empowered_diamatine_crystal_shard').displayName('Empowered Diamatine Blue Crystal Shard').glow(true)
    event.create('kubejs_actuallyadditions:empowered_emeradic_crystal_shard').displayName('Empowered Emeradic Crystal Shard').glow(true)
    event.create('kubejs_actuallyadditions:empowered_restonia_crystal_shard').displayName('Empowered Restonia Crystal Shard').glow(true)
    ...
    event.createCustom('kubejs_thermal:twinite_rf_coil_augment',() =>new $AugmentItem(new $Item$Properties(), {Type: 'RF', RFXfer: 16, RFMax: 16})).displayName('Twinite Expanded RF Coil')
    event.createCustom('kubejs_thermal:twinite_rf_coil_storage_augment',() =>new $AugmentItem(new $Item$Properties(), {Type: 'RF', RFXfer: 8, RFMax: 24})).displayName('Twinite Stabilized RF Coil')
    event.createCustom('kubejs_thermal:twinite_rf_coil_xfer_augment',() =>new $AugmentItem(new $Item$Properties(), {Type: 'RF', RFXfer: 24, RFMax: 8})).displayName('Twinite High-Flux RF Coil')
    event.createCustom('kubejs_thermal:twinite_fluid_tank_augment',() =>new $AugmentItem(new $Item$Properties(), {Type: 'Fluid', FluidMax: 16})).displayName('Twinite Expanded Tank Construction')
    event.createCustom('kubejs_thermal:twinite_machine_speed_augment',() =>new $AugmentItem(new $Item$Properties(), {Type: 'Machine', MachineEnergy: 1, MachinePower: 1.1})).displayName('Twinite Flux Linkage Amplifier')
    event.createCustom('kubejs_thermal:twinite_machine_efficiency_augment',() =>new $AugmentItem(new $Item$Properties(), {Type: 'Machine', MachineEnergy: 0.7, MachineSpeed: -0.1})).displayName('Twinite Flux Efficiency')
    event.createCustom('kubejs_thermal:twinite_machine_output_augment',() =>new $AugmentItem(new $Item$Properties(), {Type: 'Machine', MachineEnergy: 1.1, MachineSec: 0.3})).displayName('Twinite Auxiliary Process Sieve')
    event.createCustom('kubejs_thermal:twinite_machine_catalyst_augment',() =>new $AugmentItem(new $Item$Properties(), {Type: 'Machine', MachineCat: 0.6, MachineEnergy: 1.1})).displayName('Twinite Catalytic Reclamation Chamber')
    event.createCustom('kubejs_thermal:twinite_potion_amplifier_augment',() =>new $AugmentItem(new $Item$Properties(), {Type: 'Potion', PotionAmp: 2, PotionDur: -0.5})).displayName('Twinite Alchemical Amplifier')
    event.createCustom('kubejs_thermal:twinite_potion_duration_augment',() =>new $AugmentItem(new $Item$Properties(), {Type: 'Potion', PotionDur: 1.5})).displayName('Twinite Alchemical Extender')
    event.createCustom('kubejs_thermal:twinite_area_radius_augment',() =>new $AugmentItem(new $Item$Properties(), {Type: 'Area', Radius: 3})).displayName('Twinite Radial Enhancement')
